...
public class BeanXMLWebServiceClient<T>
{
    ...
    {
    	System.out.print("initiating httmp request");
    ...
    {
    	System.out.print("createHttpRequestForRequestType");
        switch (requestType)
        {
            case GET:
    ...
    {
    	System.out.println("createGetHttpRequest");
    ...
    {
    	System.out.println("createPostHttpRequest");
        ResponseHandler<Response<T>> responseHandler = BeanXMLResponseHandlerFactory
                .newMetabolicResponseHandler();
    ...
    {
    	System.out.println("createMultipartFormPostHttpRequest");
        ResponseHandler<Response<T>> responseHandler = BeanXMLResponseHandlerFactory
                .newMetabolicResponseHandler();
